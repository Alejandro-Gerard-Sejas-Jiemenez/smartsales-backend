...
INSTALLED_APPS = [
    ...
    'apps.analisis_inteligencia',
    'apps.catalogo',
    'apps.venta_transacciones',
]

AUTH_USER_MODEL = 'acceso_seguridad.Usuario'
...
DATABASES = {
    'default': {
        ...
        'PORT': config('DB_PORT', cast=int),
            # Solo agrega sslmode si no es localhost
        **({'OPTIONS': {'sslmode': 'require'}} if config('DB_HOST') != 'localhost' else {}),
        'CONN_MAX_AGE': 60,  
    }
}
